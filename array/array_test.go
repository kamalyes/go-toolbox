 ...
 * @FilePath: \go-toolbox\array\array_test.go
 * @Description:
 *
...
func TestInterfaceArrayDiffSet(t *testing.T) {
	...
	for _, tc := range cases {
		result := InterfaceArrayDiffSet(tc.arr1, tc.arr2)
...
func TestInterfaceArrayUnion(t *testing.T) {
	...
	for _, tc := range testCases {
		result := InterfaceArrayUnion(tc.arr1, tc.arr2)
...
func TestIsInterfaceArrayExistElement(t *testing.T) {
	...
	for _, tc := range cases {
		got := IsInterfaceArrayExistElement(tc.array, tc.element)
		if got != tc.want {
...
func TestIsExistRepeatInInterfaceArray(t *testing.T) {
	...
	for _, tc := range cases {
		result := IsExistRepeatInInterfaceArray(tc.array)
...
func TestInt64ToStringWithDecimals(t *testing.T) {
	...
	for _, tc := range cases {
		result := Int64ToStringWithDecimals(tc.num, tc.digit)
		if result != tc.expected {
...
func TestRemoveEmptyInterfaceInArray(t *testing.T) {
	...
	for _, tc := range cases {
		result := RemoveEmptyInterfaceInArray(tc.array)
...
func TestRemoveDuplicatesInInterfaceSlice(t *testing.T) {
	...
	for _, tc := range cases {
		result := RemoveDuplicatesInInterfaceSlice(tc.numbers)
		if !reflect.DeepEqual(result, tc.expected) {
...
func TestRemoveZeroInInterfaceSlice(t *testing.T) {
	...
	for _, tc := range cases {
		result := RemoveZeroInInterfaceSlice(tc.array)
		if !reflect.DeepEqual(result, tc.expected) {
